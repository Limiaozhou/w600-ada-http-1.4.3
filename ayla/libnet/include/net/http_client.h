...
#define HTTP_CLIENT_KEEP_OPEN_WAIT    50000	/* TCP Keep Open Wait */
#define HTTP_CLIENT_KEEP_OPEN_CNT    4 /* TCP Keep Open Wait CNT */
...
struct http_client {
	...
	u8 http_tx_chunked:1;	/* http payload chunked encoding */
