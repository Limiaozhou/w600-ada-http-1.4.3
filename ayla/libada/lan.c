...
#ifndef AYLA_LAN_SUPPORT
#error AYLA_LAN_SUPPORT not defined
#endif
...
{
	return tls_mem_alloc(CLIENT_LAN_BUF_LEN);
}
...
static void client_lan_clearout(struct client_lan_reg *lan)
{
    ...
    state->get_echo_inprog = 0; //added by z with h's sugg on 20181114
