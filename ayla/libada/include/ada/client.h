...
#define CLIENT_LOCAL_WAIT	    10000	/* lan response wait, milliseconds */
 ...
 */
enum ada_svc_status {
	ADA_SVC_DOWN = 0,	/* service communication is down */
	ADA_SVC_UP,		/* up and operating normally */
	ADA_SVC_OVERLOADED,	/* up but overloaded */
};
