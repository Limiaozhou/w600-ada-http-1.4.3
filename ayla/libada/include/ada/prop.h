...
#define PROP_SEND_TIMEOUT	45000	/* (ms) send timeout */
...
struct prop {
	...
	struct prop_queue *queue; /**< queue prop is on */
...
enum prop_cb_status {
	PROP_CB_BEGIN,
	PROP_CB_BEGIN_MULTI,	/* begin one or more sends */
	PROP_CB_CONTINUE,
	PROP_CB_DONE,
	...
	PROP_CB_TIMEOUT,   /* prop send request timed-out */
};
...
enum ada_err prop_mgr_dp_close(enum prop_cb_status, void *);
enum ada_err prop_mgr_dp_put(enum prop_cb_status, void *);
enum ada_err prop_mgr_dp_req(enum prop_cb_status, void *);
#endif
