...
#ifdef  AYLA_CU
#define CLIENT_SERVER_HOST_DEFAULT "consumer1-ads"
#define CLIENT_SERVER_HOST_DEF_FMT "consumer1-ads.%s"
#else
...
struct client_state {
	...
	u8 ping_ssl:1;			/* if non-zero, use /ping with HTTPS */
	...
	enum ada_svc_status svc_status; /* app level service status */
