 ...
 */
#define BATCH_MAX_CNT			(1)
#define BATCH_MAX_SIZE			(4*1024)
...
struct batch {
	...
	struct batch_dp dps[BATCH_MAX_CNT];
};
...
/**
 * Free batch buffer and its contained data points.
 *
 * \param b is the batch buffer to be freed.
 */
